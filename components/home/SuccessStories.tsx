...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    flag: "🇦🇪",
    quote:
      "Blitz Immigration guided me through every step of the recruitment process. Within a few months, I secured a position in Dubai with a reputable company. The process was smooth, transparent, and professional.",
  },
  {
    id: "arif",
    name: "Mohammad Arif",
